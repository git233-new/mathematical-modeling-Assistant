...
def make_figure(output_stem: Path) -> None:
    ...
    ax.set_title("基于RMSE的平滑三维调参曲面", fontsize=14, pad=18)
    ax.set_xlabel("最大树深", fontsize=13, labelpad=10)
    ax.set_ylabel("决策树数量", fontsize=13, labelpad=10)
    ax.set_zlabel("均方根误差", fontsize=12, labelpad=8)
    ax.set_xlim(0, 40)
    ax.set_ylim(205, 0)
