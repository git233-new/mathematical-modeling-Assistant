...
7. **生成论文**：
   - **强制读取**（见强制读取协议）：动笔前 Read `文档/论文写作.md`（§二路由表确定每章写法来源）与 `文档/论文合规与自审.md`；写作范式文件按路由表**写对应章节前**读——摘要→`文档/摘要写作范式.md`、问题重述与分析→`文档/问题重述与分析写作.md`、假设与符号→`文档/假设与符号写作.md`；全文措辞按 `知识库/写作增强/去AI味指南.md`；评审锚点与题型画像按 `知识库/评审增强/国赛评审标准.md`、`知识库/方法库/问题分类.md`。每章动笔前必须确认已读对应文件
...
| 论文写法 / 去AI味 | `文档/论文写作.md §二路由表`（先读路由表，按表逐章读对应文件）→ `文档/摘要写作范式.md`、`文档/问题重述与分析写作.md`、`文档/假设与符号写作.md`、`知识库/写作增强/获奖论文模板与创新点.md`（全库蒸馏的章节骨架与创新点模式，定骨架与检验计划） → `知识库/写作增强/去AI味指南.md`（含 25 通用 + 15 数模专用模式，6-Pass 写作流程）、`知识库/写作增强/七轮自审框架.md`（含 42 项反模式清单）、`知识库/评审增强/国赛评审标准.md`、`知识库/方法库/问题分类.md`、`知识库/方法库/质检清单.md` |
