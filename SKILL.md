...
| 论文写法 / 去AI味 | `文档/论文写作.md` → `知识库/写作增强/获奖论文模板与创新点.md`（全库蒸馏的章节骨架与创新点模式，定骨架与检验计划） → `知识库/写作增强/去AI味指南.md`（含 35 类通用模式速查）、`知识库/写作增强/七轮自审框架.md`（含 42 项反模式清单）、`知识库/写作增强/摘要写作范式.md`、`知识库/方法库/质检清单.md` |
